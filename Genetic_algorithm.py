...
def crossover_individual(individual1: str, individual2: str, cross_rate: float) -> Tuple[str, str]:
    ...
    """
    if individual1.endswith("R") or individual1.startswith("R") or individual2.endswith("R") or individual2.startswith(
            "R"):
...
def genetic_algorithm(num_gen: int, num_individuals: int, func: Callable,
...
def plot_route(route, allpoints):
    ...
    :param allpoints: all the possible points
...
while True:
    ...
    best_route = genetic_algorithm(num_gen=150, num_individuals=20, func=reverse_roulette,
